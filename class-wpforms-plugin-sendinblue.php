 ...
 * @since      1.0.0
 * @copyright  Copyright (c) 2022, Georg Leber
 * @license    GPL-3.0+
 */
...
class WPForms_Plugin_SendinBlue
{
    ...
    function settings_section_content($instance)
    {
        ...
        wpforms_panel_field(
            'text',
            'settings',
            'be_sendinblue_field_additional_boolean_attributes',
            $instance->form_data,
            __('Additional Boolean Attributes', 'wpforms_plugin_sendinblue')
        );
    ...
    function send_data_to_sendinblue($fields, $entry, $form_data, $entry_id)
    {
        ...
        $api_key = $sib_redirect_url = $sib_list_ids = $sib_template_id = $additional_attributes = false;
        ...
        if (!empty($form_data['settings']['be_sendinblue_field_additional_boolean_attributes'])) {
            $additional_attributes = intval($form_data['settings']['be_sendinblue_field_additional_boolean_attributes']);
        }
